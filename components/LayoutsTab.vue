...
const manualActiveLayoutId = computed(
        ...
        >
            <template #description>
                <ul class="space-y-2 text-sm">
                    <li v-for="issue in globalBanner.issues" :key="issue.id">
            ...
            <div class="flex items-start gap-2 text-sm">
                ...
                <div>
                    <p class="font-semibold">
                        {{ $t('home.manualNoActiveTitle') }}
                    </p>
                    <p class="text-(--ui-text-muted)">
                        {{ $t('home.manualNoActiveBody') }}
                    </p>
                </div>
            </div>
        </UCard>
