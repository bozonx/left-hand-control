...
onMounted(() => {
    ...
    const input = (
        commandInput.value as unknown as {
...
<template>
    ...
    >
        <div class="flex items-start justify-between gap-4">
            ...
            <div
                class="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100"
            >
        ...
        <div v-if="usage.length" class="mt-3 flex flex-wrap gap-1 text-xs">
