...
<template>
    ...
    >
        <div class="flex-1 flex flex-col gap-4 min-w-0">
            ...
            <div v-if="usage.length" class="flex flex-wrap gap-1 text-xs">
    ...
    <UModal
        v-model:open="stepConfirmOpen"
        :title="$t('macros.confirmDeleteStepTitle')"
    >
        <template #body>
