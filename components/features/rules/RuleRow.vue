...
const hasConditions = computed(() =>
    Boolean(
        (rule.value.conditionGameMode &&
            rule.value.conditionGameMode !== 'ignore') ||
...
const hasWarnings = computed(() =>
    (props.issues ?? []).some((issue) => issue.severity === 'warning'),
)
...
<template>
    ...
    >
        <div class="flex-1 flex flex-col gap-5">
                ...
                <UFormField>
                    ...
                    >
                        ...
                        <UBadge
                            v-for="(
                                app, index
                            ) in rule.conditionAppsWhitelist?.filter((value) =>
                                value.trim(),
                            )"
                        ...
                        <UBadge
                            v-for="(
                                app, index
                            ) in rule.conditionAppsBlacklist?.filter((value) =>
                                value.trim(),
                            )"
            ...
            <div v-if="issues?.length" class="flex flex-wrap gap-1.5">
                ...
                >
                    ...
                    />
                    {{
                        $t(ruleIssueMessageKey(issue), {
                            trigger: issue.trigger ?? rule.key,
                        })
                    }}
                </UBadge>
            </div>
        ...
        <div class="w-[16rem] flex flex-col gap-4">
