...
<template>
    <div class="space-y-4">
        <UCard>
            ...
            <div class="space-y-4">
                ...
                <MacroEditorCard
                    ...
                    :default-step-pause-ms="
                        config.settings.defaultMacroStepPauseMs
                    "
                    :default-modifier-delay-ms="
                        config.settings.defaultMacroModifierDelayMs
                    "
        ...
        <UModal
            ...
            :title="$t('macros.confirmDeleteTitle')"
        >
            <template #body>
                <p class="text-sm">
