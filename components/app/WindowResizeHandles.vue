...
const handles: { dir: WindowResizeDirection, class: string }[] = [
  { dir: 'North', class: 'top-0 left-2 right-2 h-[5px] cursor-ns-resize' },
  { dir: 'South', class: 'bottom-0 left-2 right-2 h-[5px] cursor-ns-resize' },
  { dir: 'West', class: 'left-0 top-2 bottom-2 w-[5px] cursor-ew-resize' },
  { dir: 'East', class: 'right-0 top-2 bottom-2 w-[5px] cursor-ew-resize' },
  { dir: 'NorthWest', class: 'top-0 left-0 size-2 cursor-nwse-resize' },
  { dir: 'NorthEast', class: 'top-0 right-0 size-2 cursor-nesw-resize' },
  { dir: 'SouthWest', class: 'bottom-0 left-0 size-2 cursor-nesw-resize' },
  { dir: 'SouthEast', class: 'bottom-0 right-0 size-2 cursor-nwse-resize' },
]
