...
import { appActionRef, commandActionRef, createDefaultConfig, macroActionRef, systemActionRef, textActionRef } from '~/types/config'
...
describe('runtime bridge composables', () => {
  ...
  it('useMacros resolves names and display labels for macros, commands and system actions', async () => {
    ...
    expect(api!.displayAction(macroActionRef('duplicateLine'))).toBe('[Macro] User duplicate')
