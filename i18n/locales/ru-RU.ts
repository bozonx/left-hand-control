...
export default {
  ...
  macros: {
    ...
    idLabel: 'ID',
    idHint:
      'Уникальный идентификатор для ссылки вида macro:<id>. Чтобы назначить макрос на клавишу, выберите это действие во вкладках «Слои» или «Раскладка». Изменяйте ID только если не используете этот макрос.',
    idPh: 'id',
    idErrors: {
